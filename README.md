...
The permutation test above checks the missingness dependency of power outage duration on the category of events that cause the power outage. A p-value of 0.005 confirms this dependency.
...
To narrow our investigation onto major power outages, we apply a filter on the original dataset to include only power outage record that affect more than 50000 people or causing a demand loss of more than 300 megawatts.
...
We also perferm probabilistic imputation on RES.PERCEN, COM.PERCEN, IND.PERCEN, RES.PRICE, COM.PRICE, IND.PRICE. As the percentages of the electricity consumption of three sectors should add up to 100%, we perform the probabilistic imputation of RES.PERCEN, COM.PERCEN, IND.PERCEN together to retain consistency.
...
The histogram shows the distribution of the total money lost in industrial sector during each power outage. The shape of the distribution is similar to the other two sectors, but the money lost is in general significantly smaller. More than 60% of the power outage events lead to money lost less than 5000 dollars. About 25% of cases, the money lost is between 5000 dollars and 15000 dollars. The rest 15% of the cases lead to more than 15000 dollars. The highest money lost in industrial sector is about 935000 dollars.
...
| fuel supply emergency         |         83004.7  |         95174.8  |         14229.5  |
| intentional attack            |          5803.57 |          4270.43 |          1242.39 |
| islanding                     |         78455.6  |         80738.6  |         28786.4  |
| public appeal                 |         25613.4  |         28884.1  |         11478.6  |
| severe weather                |         19795.6  |         17216.5  |          7811.15 |
| system operability disruption |         24295.8  |         29011.2  |          7420.46 |
...
In this pivot table, we observe that the average money lost from industrial sector is significantly smaller under all categories of events than from the other two sectors, which is consistent with the conclusion we draw in the univariate analysis. The average money lost in residential and commercial sectors are very close. There is a slightly higher average money lost in residential sector due to equipment failure, intentional attack, and severe whether. The rest categories of events result in slightly higher average money lost in commercial sector.
...
Unfortunately, the pivot table cannot tell a clear difference between the overall money lost in the commercial sector and the residential sector. Given that the average money lost is higher in some residential sector categories of events, we decide to use permutation testing to further investigate whether the money lost in residential sector is larger than the money lost in commercial sector.
